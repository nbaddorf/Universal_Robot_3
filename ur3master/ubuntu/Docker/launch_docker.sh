...
docker run -it --publish-all --user ros --add-host nick-ros-master:127.0.0.1 -v /home/$USER/Github/Universal_Robot_3/ur3master/ros_code:/home/ros/catkin_ws/src/ur3master ur3master_docker_image