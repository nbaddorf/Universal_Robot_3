...
docker run -it --user ros --network=host --add-host ur3remote:192.168.1.151 --device=/dev/ttyUSB0 --ipc=host -v /home/$USER/Universal_Robot_3/ur3robot/ros_code:/home/ros/catkin_ws/src/ur3robot ur3robot_docker_image
